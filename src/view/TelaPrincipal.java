...
//        }
    ...
    private void carregar_suprimentos() {
        ...
        try {
            ...
            while (todos.next()) {
                Object[] linha = {todos.getString("codLote"),todos.getString("nomeEquip"), todos.getBoolean("Reutilizavel"),todos.getString("dtCompra"),todos.getString("dtValidade"),todos.getString("quantidade")};
                tab.addRow(linha);
            }
            todos.close();
    ...
    private void initComponents() {
        ...
        tableSupri.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Reutilizavel", "Data de Compra", "Validade", "Quantidade"
            }
        ) {
